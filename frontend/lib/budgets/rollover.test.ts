...
test('rollover ON: April leftover becomes May carry_forward', async () => {
  ...
  await exec(
    `INSERT INTO transactions (id,ledger_id,account_id,date,amount,amount_base,exchange_rate,exchange_rate_date,description,category_id,status,currency,created_at)
     VALUES ('t-apr-1','personal','chk','2026-04-10',-400,-400,1,'2026-04-10','Groceries','food','confirmed','USD','2026-04-10')`,
  );
...
test('pending_amount activates at the boundary (rollover on)', async () => {
  ...
  await exec(
    `INSERT INTO transactions (id,ledger_id,account_id,date,amount,amount_base,exchange_rate,exchange_rate_date,description,category_id,status,currency,created_at)
     VALUES ('t-apr-2','personal','chk','2026-04-10',-200,-200,1,'2026-04-10','Groceries','food','confirmed','USD','2026-04-10')`,
  );
  await rollBudgetsIfDue(exec, '2026-05-15');
