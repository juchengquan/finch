...
projects are **generated by XcodeGen and git-ignored** (`xcodegen generate --spec
project.yml,project-mac.yml` first — iOS and macOS are separate projects). Build/test with
