...
const MOCK = {
  ...
  // Accounts
  accounts: [
    { id: 'chk', name: 'Chase Checking',     type: 'checking', balance: 4218.50,  last4: '4421', color: '#1f3a5f' },
    { id: 'sav', name: 'Marcus Savings',     type: 'savings',  balance: 8120.00,  last4: '7782', color: '#c89a3e' },
    { id: 'cc',  name: 'Amex Gold',          type: 'credit',   balance: -842.18,  last4: '1009', color: '#3a2d1f' },
    { id: 'inv', name: 'Fidelity Brokerage', type: 'invest',   balance: 21430.00, last4: '5530', color: '#2d4a3a' },
  ],
