...
> - `plans/ios-macos/IOS_MACOS_PHASE_6_2_DESIGN.md` (this file) — Phase 6.2
>
...
- `plans/ios-macos/IOS_MACOS_WIRE_FORMAT.md` §3 — I18nError wire format
- `plans/ios-macos/IOS_MACOS_PLAN.md` §7 — the platform integrations
- `plans/ios-macos/IOS_MACOS_PHASE_6_1_DESIGN.md` — Phase 6.1 (Spotlight; reuses `DeepLinkRouter`)
- `plans/ios-macos/IOS_MACOS_PHASE_6_3_DESIGN.md` — Phase 6.3 (Biometric; same Xcode project)
- `plans/ios-macos/IOS_MACOS_PHASE_1_5_DESIGN.md` §3 — the weekly digest (uses `weeklyDigest` selector)
