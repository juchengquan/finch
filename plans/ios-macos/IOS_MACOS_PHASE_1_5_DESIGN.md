...
> - `plans/ios-macos/IOS_MACOS_ROADMAP.md` — the 8-phase arc (Phase 1.5 is sketched
>   there; this is the **full design** for that sketch)
> - `plans/ios-macos/IOS_MACOS_PHASE_1_5_DESIGN.md` (this file)
>
...
- `plans/ios-macos/IOS_MACOS_WIRE_FORMAT.md` §5 — the fixture format
- `plans/ios-macos/IOS_MACOS_PHASE_1_DESIGN.md` §1, §5, §8 — Phase 1.0 (the 4-tab shell + 7 selectors + parity suite)
- `plans/ios-macos/IOS_MACOS_PHASE_2_DESIGN.md` — Phase 2 (chokepoint + write screens)
- `plans/ios-macos/IOS_MACOS_PLAN.md` §2.4 — the selectors (read brains)
