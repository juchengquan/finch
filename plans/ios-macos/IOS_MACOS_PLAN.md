...
**Companion navigation**: `plans/ios-macos/IOS_MACOS_INDEX.md` — the navigation
index (glossary of recurring terms, "where do X live" location
index, master iPhone tab list, cross-spec impact).

**Companion reference**: `plans/ios-macos/IOS_MACOS_WIRE_FORMAT.md` — the
...
8. **Row-level sync (the full §4.3-C) — committed to building
    ...
    `plans/ios-macos/IOS_MACOS_PHASE_8_DESIGN.md` for the full design.
