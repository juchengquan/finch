...
> - `plans/ios-macos/IOS_MACOS_PHASE_1_DESIGN.md` — full design for Phase 1.0
> - `plans/ios-macos/IOS_MACOS_PHASE_1_5_DESIGN.md` — full design for Phase 1.5
> - `plans/ios-macos/IOS_MACOS_ROADMAP.md` — the 8-phase arc (Phase 2 is sketched
>   there; this is the **full design** for that sketch)
> - `plans/ios-macos/IOS_MACOS_PHASE_2_DESIGN.md` (this file)
>
...
- `plans/ios-macos/IOS_MACOS_INDEX.md` §2.1 — the 74 actions location index
...
- `plans/ios-macos/IOS_MACOS_PHASE_1_DESIGN.md` — Phase 1.0 (read-only shell)
- `plans/ios-macos/IOS_MACOS_PHASE_1_5_DESIGN.md` — Phase 1.5 (selectors + parity tests)
- `plans/ios-macos/IOS_MACOS_PHASE_3_DESIGN.md` — Phase 3 (adaptive shell, post-Phase-2)
- `plans/ios-macos/IOS_MACOS_PHASE_6_4_DESIGN.md` — Phase 6.4 (App Intents dispatch)
- `plans/ios-macos/IOS_MACOS_PHASE_6_5_DESIGN.md` — Phase 6.5 (setEntryAttachment is the 75th)
