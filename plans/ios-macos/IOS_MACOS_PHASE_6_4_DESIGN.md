...
> - `plans/ios-macos/IOS_MACOS_PHASE_6_4_DESIGN.md` (this file) — Phase 6.4
>
...
- `plans/ios-macos/IOS_MACOS_PHASE_2_DESIGN.md` — Phase 2 (chokepoint; intents dispatch through it)
- `plans/ios-macos/IOS_MACOS_PHASE_6_1_DESIGN.md` — Phase 6.1 (Spotlight; same `DeepLinkRouter`)
- `plans/ios-macos/IOS_MACOS_PHASE_6_3_DESIGN.md` — Phase 6.3 (Biometric; sensitive intents gated)
