...
| **iPad multi-column** | M | 🟡 Ledger joins the 3-column shell + split column widths (spec/plan `2026-07-07-ipad-multicolumn-*.md`). Deferred there: Activity/Scheduled detail columns (need net-new inline detail views) and sidebar-collapse persistence (rotation auto-collapse caveat) |
