...
| **Watch: complication + on-wrist quick-add** | M | ✅ Done — CP1 #412 (WCSession transport + live glance; spec #408, plan #410) · CP2 #415 (`FinchWatchComplication`, 4 accessory families + reload-on-push; spec/plan #413) · quick-add **templates** #417 (repeat-last from the glance; design record `2026-07-07-watch-quickadd-templates-design.md`) · **CP3 composer** this PR (crown amount + category chips from a snapshot-borne catalog; posts pending with staleness fallbacks + tap-date booking; spec/plan `2026-07-07-watch-cp3-*.md` #418, post-#417 addendum). **Watch sub-project complete** |
