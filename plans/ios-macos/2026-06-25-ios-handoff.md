...
| **Watch: complication + on-wrist quick-add** | M | 🟡 CP1+CP2 done — CP1 #412 (WCSession transport + live glance; spec #408, plan #410) · CP2 this PR (`FinchWatchComplication` WidgetKit extension, 4 accessory families + reload-on-push; spec/plan #413). **On-wrist quick-add (CP3) remains** — own spec (reverse WCSession + `finch://` routes) |
