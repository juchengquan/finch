...
> - `plans/ios-macos/IOS_MACOS_PHASE_6_3_DESIGN.md` — Phase 6.3 (Biometric)
> - `plans/ios-macos/IOS_MACOS_PHASE_6_4_DESIGN.md` — Phase 6.4 (App Intents)
> - `plans/ios-macos/IOS_MACOS_PHASE_7_DESIGN.md` — Phase 7 (widgets + Watch)
> - `plans/ios-macos/IOS_MACOS_ROADMAP.md` — 8-phase arc
> - `plans/ios-macos/IOS_MACOS_PHASE_6_5_DESIGN.md` (this file) — Phase 6.5
>
...
- `plans/ios-macos/IOS_MACOS_INDEX.md` §2.4, §2.5 — App Group + 75th action (`setEntryAttachment`)
- `plans/ios-macos/IOS_MACOS_WIRE_FORMAT.md` §2 — the 74+1 Args catalogue
- `plans/ios-macos/IOS_MACOS_PLAN.md` §2.5 — the receipt attachments feature
- `plans/ios-macos/IOS_MACOS_PHASE_5_DESIGN.md` — Phase 5 (iCloud; App Group is added here in Phase 6.5, not Phase 5)
- `plans/ios-macos/IOS_MACOS_PHASE_7_DESIGN.md` — Phase 7 (widgets + Watch; reuses App Group)
- `plans/ios-macos/IOS_MACOS_PHASE_2_DESIGN.md` §3.3 — `setEntryAttachment` action
