...
> - `plans/IOS_MACOS_ROADMAP.md` — the 8-phase arc
> - `plans/IOS_MACOS_PHASE_1_DESIGN.md` — Phase 1.0 (read-only iPhone; uses fixtures)
> - `plans/IOS_MACOS_PHASE_1_5_DESIGN.md` — Phase 1.5 (Insights; uses parity fixtures)
> - `plans/IOS_MACOS_PHASE_2_DESIGN.md` — Phase 2 (74-action chokepoint; per-action fixtures)
> - `plans/IOS_MACOS_PHASE_5_DESIGN.md` — Phase 5 (pack engine; uses pack format)
> - `plans/IOS_MACOS_PHASE_8_DESIGN.md` — Phase 8 (CloudKit row-level sync)
> - `plans/IOS_MACOS_WIRE_FORMAT.md` (this file) — the wire contracts that
...
```typescript
// plans/IOS_MACOS_WIRE_FORMAT.md §5.1 — the canonical schema
...
```typescript
// plans/IOS_MACOS_WIRE_FORMAT.md §5.4 — informal interface;
