...
**Input design spec:** `plans/IOS_MACOS_PHASE_2_DESIGN.md` (1,189 lines, 12 sections + §0. Map TOC)
**Input wire-format annex:** `plans/IOS_MACOS_WIRE_FORMAT.md` §2 (the 74-action Args catalogue + the 75th `setEntryAttachment` from Phase 6.5)
