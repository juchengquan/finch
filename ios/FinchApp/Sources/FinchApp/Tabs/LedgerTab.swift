...
/// iPhone it opens as a top-level right-slide cover from the top-left corner
/// control (`TabBarShell` + `router.showLedger`); on iPad/Mac it's a sidebar
/// section. The single global active ledger scopes the rest of the app.
