...
/// Persists which Budgets-tab groups are *collapsed*, per ledger (keyed by
...
/// ledgers don't share state. Mirrors `AccountGroupCollapse`.
enum BudgetGroupCollapse {
    private static let base = "finch.budgets.collapsedGroups"
